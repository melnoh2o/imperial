...
export function useFAQData() {
  const data = [
    ...
    },
    {
      ...
      answer:
        'Бесплатный тур включает в себя следующие услуги: трансфер с аэропорта, бесплатное проживание в течение 3-7 дней, презентацию проектов от застройщиков. Кроме того, при покупке недвижимости мы гарантируем возврат цен за билеты.',
    },
    {
      id: useId(),
